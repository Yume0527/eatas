<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-gray-
...
transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-
...
1.414z" clip-rule="evenodd" />
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')">
                            https://gs-dec-202408.deno.dev/print.html 87/208
                            2024/10/10 10:58 G's-DEC-202408
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        <!-- Authentication -->
...
center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500
...
'inline-flex': ! open }"
                            class="inline-flex" stroke-linecap="round" stroke-linejoin="round" stroke-
...
'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('evaluation')" :active="request()->routeIs('evaluation')">
                {{ __('食事評価') }}
            </x-responsive-nav-link>

        </div>
        <!-- Responsive Settings Options -->
        https://gs-dec-202408.deno.dev/print.html 88/208
        2024/10/10 10:58 G's-DEC-202408
